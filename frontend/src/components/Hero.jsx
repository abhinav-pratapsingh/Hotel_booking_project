...
const Hero = ()=>{
    return (
        <div className= 'flex flex-col items-start justify-center md:px-16 lg:px-24 xl:px-32 text-white bg-cover bg-no-repeat bg-center h-screen' style={{backgroundImage : `url(${heroImage})`}} >
